...
from app.similarity_search.pipeline import search_similarities, rank_results
...
class TestPipelineExceptionHandling:
    ...
    def test_search_similarities_with_exception_logging(self):
        ...
        query_df = pd.DataFrame({
            "query_name": ["q1"],
            "fp": [get_morgan_fp(Chem.MolFromSmiles("CCO"), 2)]
        })
        
        ref_df = pd.DataFrame({
            "fp": [get_morgan_fp(Chem.MolFromSmiles("CC"), 2)]
        })
    ...
    def test_rank_results_logging_per_query(self):
        ...
        with patch("app.similarity_search.pipeline.logger") as mock_logger:
            result = rank_results(combined_results, query_df, top_n=2)
...
class TestVisualizationDistributionExceptionPaths:
    ...
    def test_visualize_distribution_with_no_plots(self):
        ...
        with patch("app.similarity_search.visualization.plt.subplots", side_effect=Exception("Plot error")):
...
class TestCSVParsingErrors:
    ...
    def test_csv_parser_error_handling(self):
        ...
        with patch("app.similarity_search.cli.pd.read_csv", 
...
class TestPipelineDebugLogging:
    ...
    def test_fingerprint_compute_error_path(self):
        ...
        with patch("app.similarity_search.pipeline.get_morgan_fp",
    ...
    def test_search_similarities_error_path(self):
        ...
        with patch("app.similarity_search.pipeline.similarity_search",
    ...
    def test_rank_results_error_path(self):
        ...
        with patch.object(combined_results, "sort_values",
                          side_effect=RuntimeError("Sort error")):
            with pytest.raises(RuntimeError):
...
class TestVisualizationErrorHandling:
    ...
    def test_visualize_distribution_error_recovery(self):
        ...
        with patch("app.similarity_search.visualization.plt.subplots",
