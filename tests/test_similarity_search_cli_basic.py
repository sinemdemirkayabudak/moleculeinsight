...
from app.similarity_search.cli import run_similarity_search, main
...
class TestRunSimilaritySearch:
    ...
    def test_main_function_file_not_found(self):
        ...
        test_args = [
            "script.py",
            "--query_file", "/nonexistent/query.csv",
    ...
    def test_main_function_generic_exception(self):
        ...
        with patch.object(sys, "argv", test_args):
            with patch("app.similarity_search.cli.run_similarity_search",
    ...
    def test_main_function_file_not_found_exit(self):
        ...
        test_args = [
            "script.py",
            "--query_file", "/missing/query.csv",
            "--reference_file", "/missing/ref.csv"
        ]
