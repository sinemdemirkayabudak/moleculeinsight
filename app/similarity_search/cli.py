...
def run_similarity_search(query_file, reference_file, radius, top_n, show_plots):
...
def create_argument_parser():
    ...
    """
    parser = argparse.ArgumentParser(description="Morgan Fingerprint Similarity Search Pipeline")

    # Input files
    parser.add_argument("--query_file", required=True, help="CSV file containing query molecules")

    parser.add_argument(
        "--reference_file", required=True, help="CSV file containing reference library"
    )

    # Output
    parser.add_argument(
        "--output_file", default="similarity_results.csv", help="Output results file"
    )
    ...
    # Ranking
    parser.add_argument("--top_n", type=int, default=20, help="Top N similar molecules")

    # Visualization options
    parser.add_argument("--show_plots", action="store_true", help="Generate similarity rank plots")
